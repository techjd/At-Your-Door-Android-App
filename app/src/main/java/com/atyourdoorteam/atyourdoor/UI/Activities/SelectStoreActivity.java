...
//                });
    ...
    private void getShops(String userCity, double latitude, double lonitude) {
        ...
        shopCall.enqueue(new Callback<List<Shop>>() {
            ...
            public void onResponse(Call<List<Shop>> call, Response<List<Shop>> response) {
                if (response.isSuccessful()) {
                    ...
                    selectStoreAdapter = new SelectStoreAdapter(shopArrayList, SelectStoreActivity.this, latitude, lonitude);
